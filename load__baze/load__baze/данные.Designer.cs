...
namespace load__baze {
    ...
    public partial class данные : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(string производитель, string наименование, string артикул, byte[] фотография, decimal цена) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow FindByномер(int номер) {
            ...
            private void InitClass() {
                ...
                this.columnпроизводитель.MaxLength = 1073741823;
                this.columnнаименование.MaxLength = 1073741823;
                this.columnартикул.MaxLength = 1073741823;
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int номер {
                get {
                    return ((int)(this[this.tableTable.номерColumn]));
                }
                set {
                    this[this.tableTable.номерColumn] = value;
                }
            }
            ...
            public string артикул {
                get {
                    try {
                        return ((string)(this[this.tableTable.артикулColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'артикул\' в таблице \'Table\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.артикулColumn] = value;
                }
            }
            ...
            public byte[] фотография {
                get {
                    try {
                        return ((byte[])(this[this.tableTable.фотографияColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'фотография\' в таблице \'Table\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.фотографияColumn] = value;
                }
            }
            ...
            public bool IsартикулNull() {
                return this.IsNull(this.tableTable.артикулColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetартикулNull() {
                this[this.tableTable.артикулColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public bool IsфотографияNull() {
                return this.IsNull(this.tableTable.фотографияColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetфотографияNull() {
                this[this.tableTable.фотографияColumn] = global::System.Convert.DBNull;
            }
...
namespace load__baze.данныеTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([номер] = @Original_номер) AND ((@IsNull_цена =" +
                " 1 AND [цена] IS NULL) OR ([цена] = @Original_цена)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Table] ([номер], [производитель], [наименование], [артикул], [фотография], [цена]) VALUES (@номер, @производитель, @наименование, @артикул, @фотография, @цена);
SELECT номер, производитель, наименование, артикул, фотография, цена FROM [Table] WHERE (номер = @номер)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@производитель", global::System.Data.SqlDbType.NText, 0, global::System.Data.ParameterDirection.Input, 0, 0, "производитель", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@артикул", global::System.Data.SqlDbType.NText, 0, global::System.Data.ParameterDirection.Input, 0, 0, "артикул", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [номер] = @номер, [производитель] = @производитель, [наименование] = @наименование, [артикул] = @артикул, [фотография] = @фотография, [цена] = @цена WHERE (([номер] = @Original_номер) AND ((@IsNull_цена = 1 AND [цена] IS NULL) OR ([цена] = @Original_цена)));
SELECT номер, производитель, наименование, артикул, фотография, цена FROM [Table] WHERE (номер = @номер)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@производитель", global::System.Data.SqlDbType.NText, 0, global::System.Data.ParameterDirection.Input, 0, 0, "производитель", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@артикул", global::System.Data.SqlDbType.NText, 0, global::System.Data.ParameterDirection.Input, 0, 0, "артикул", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::load__baze.Properties.Settings.Default.connect_baza;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT номер, производитель, наименование, артикул, фотография, цена FROM dbo.[Ta" +
                "ble]";
        ...
        public virtual int Fill(данные.TableDataTable dataTable) {
        ...
        public virtual данные.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            данные.TableDataTable dataTable = new данные.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(данные.TableDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(данные dataSet) {
        ...
        public virtual int Delete(int Original_номер, global::System.Nullable<decimal> Original_цена) {
        ...
        public virtual int Insert(int номер, string производитель, string наименование, string артикул, byte[] фотография, global::System.Nullable<decimal> цена) {
        ...
        public virtual int Update(int номер, string производитель, string наименование, string артикул, byte[] фотография, global::System.Nullable<decimal> цена, int Original_номер, global::System.Nullable<decimal> Original_цена) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string производитель, string наименование, string артикул, byte[] фотография, global::System.Nullable<decimal> цена, int Original_номер, global::System.Nullable<decimal> Original_цена) {
            return this.Update(Original_номер, производитель, наименование, артикул, фотография, цена, Original_номер, Original_цена);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateUpdatedRows(данные dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._tableTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateInsertedRows(данные dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._tableTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateDeletedRows(данные dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._tableTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        public virtual int UpdateAll(данные dataSet) {
            if ((dataSet == null)) {
